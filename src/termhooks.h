...
enum event_kind
{
  ...
  /* In a BRACKETED_PASTE_EVENT, .arg is the pasted text as a Lisp
     string.  Generated by the kitty keyboard protocol parser when it
     encounters bracketed paste markers (\e[200~ ... \e[201~).  */
